...
num_worker = 2 #original 16  # total worker in all gpu
batch_size = 1 #original 16  # total batch size in all gpu
batch_size_val = None  # auto adapt to bs 1 for each gpu
batch_size_test = None  # auto adapt to bs 1 for each gpu
epoch = 100 #original 100  # total epoch, data loop = epoch // eval_epoch
eval_epoch = 100 #original 100  # sche total eval & checkpoint epoch
